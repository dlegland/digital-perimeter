%CHECKPERIMETER_LUNER40D30  Compare perimeter measurements on a lune.
%
...
% lune radius, and theoretical perimeter (same as disk with same radius)
R = 40;
d = 30;
pth = 2*pi*R;
shapeName = sprintf('LuneR%02dD%02d', R, d);
